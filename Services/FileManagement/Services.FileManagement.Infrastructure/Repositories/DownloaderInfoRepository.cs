...
{
    public class DownloaderInfoRepository : GenericRepository<DownloaderInfo>, IDownloaderInfoRepository
    {
        public DownloaderInfoRepository(FileManagementDbContext context) : base(context) { }
    }
}
