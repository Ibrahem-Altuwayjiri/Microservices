...
{
    public class EmailDetailsRepository : GenericRepository<EmailDetails>, IEmailDetailsRepository
    {
        public EmailDetailsRepository(EmailDbContext context) : base(context) { }
    }
}
